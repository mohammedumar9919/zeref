...
<required_reading>
@C:/Projects/zeref/.cursor/get-shit-done/references/user-story-template.md
@C:/Projects/zeref/.cursor/get-shit-done/references/spidr-splitting.md
@C:/Projects/zeref/.cursor/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@C:/Projects/zeref/.cursor/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@C:/Projects/zeref/.cursor/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@C:/Projects/zeref/.cursor/get-shit-done/references/spidr-splitting.md`. Briefly:
