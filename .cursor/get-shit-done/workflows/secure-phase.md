...
```
Agent(
  prompt="Read C:/Projects/zeref/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Projects/zeref/.cursor/get-shit-done/templates/SECURITY.md`
