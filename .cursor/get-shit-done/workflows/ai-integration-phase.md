...
<required_reading>
@C:/Projects/zeref/.cursor/get-shit-done/references/ai-frameworks.md
@C:/Projects/zeref/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Projects/zeref/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Projects/zeref/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Projects/zeref/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Projects/zeref/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Projects/zeref/.cursor/agents/gsd-eval-planner.md for instructions.
