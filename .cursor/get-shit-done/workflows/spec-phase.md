...
```bash
INIT=$(node "C:/Projects/zeref/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Projects/zeref/.cursor/get-shit-done/templates/spec.md.
