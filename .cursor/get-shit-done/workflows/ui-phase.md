...
```markdown
Read C:/Projects/zeref/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Projects/zeref/.cursor/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Projects/zeref/.cursor/agents/gsd-ui-checker.md for instructions.
