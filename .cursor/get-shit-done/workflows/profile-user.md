...
Key references:
- @C:/Projects/zeref/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @C:/Projects/zeref/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/Projects/zeref/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/Projects/zeref/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/Projects/zeref/.cursor/get-shit-done/USER-PROFILE.md" "C:/Projects/zeref/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/Projects/zeref/.cursor/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/Projects/zeref/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @C:/Projects/zeref/.cursor/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/Projects/zeref/.cursor/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to C:/Projects/zeref/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/Projects/zeref/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/Projects/zeref/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/Projects/zeref/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="C:/Projects/zeref/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    C:/Projects/zeref/.cursor/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/Projects/zeref/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        C:/Projects/zeref/.cursor/.cursor/rules/
```
