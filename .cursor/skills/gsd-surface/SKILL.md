...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Projects/zeref/.cursor/.gsd-surface.json`
(sibling to `C:/Projects/zeref/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Projects/zeref/.cursor/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Projects/zeref/.cursor/skills`).
...
`C:/Projects/zeref/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Projects/zeref/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Projects/zeref/.cursor/.gsd-surface.json`
Install profile marker: `C:/Projects/zeref/.cursor/.gsd-profile`
Skill dirs: `C:/Projects/zeref/.cursor/skills/gsd-*/`
Engine module: `C:/Projects/zeref/.cursor/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/Projects/zeref/.cursor/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
