...
@C:/Projects/zeref/.cursor/get-shit-done/references/thinking-models-research.md
...
```bash
node "C:/Projects/zeref/.cursor/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
