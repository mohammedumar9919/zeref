# CLOUD-A5 — Submission pack (docs)

**Queue ID:** CLOUD-A5  
**Remote:** Docs/scripts yes · video = laptop

## Goal

College submission materials: abstract, demo script (4 beats), PPT outline, README demo section. No new product features.

## Allowed paths

- `docs/cloud/**`, `docs/` submission folder if created (`docs/submission/`)
- `README.md` demo section
- Script outlines only
