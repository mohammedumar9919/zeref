# LAPTOP-UAT — College demo leftovers (human)

**Queue ID:** LAPTOP-UAT  
**Status:** LAPTOP_ONLY (see [../QUEUE.md](../QUEUE.md))  
**Depends on:** Track A DONE (A0–A5); optional live Track B already proven on this laptop
...
Open http://localhost:3000/cockpit — badges must say **Fixture** / **SIMULATED**. Do **not** use `live-data-start.ps1` for the graded video.

Follow beats in [../../submission/DEMO_SCRIPT.md](../../submission/DEMO_SCRIPT.md) (2–3 min).
...
- [ ] PTT hold → transcript → ack → result (mock TTS tone OK in fixture)
...
- Product Track B next is still **TRACK-B-DEFER** (Next 16 / publish / auth / vector) — unlock only when Lead says so.
- Live ops already on laptop: IG + FB BD + bulk collect (`CLOUD-B5`) — keep separate from the fixture demo video.
