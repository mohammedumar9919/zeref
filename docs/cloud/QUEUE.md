...
| 10 | CLOUD-B3 | Competitor Business Discovery + reel ideas (FB Login token) | OPEN | `cloud/b3-` | [phases/B3-competitor-discovery.md](./phases/B3-competitor-discovery.md) |
...
- **First OPEN for workers right now:** **CLOUD-B3** → [phases/B3-competitor-discovery.md](./phases/B3-competitor-discovery.md)
- **TRACK-B-DEFER** (formerly TRACK-B-REST) stays BLOCKED on purpose — Next 16 / publish / auth / vector. **Do not treat that row as “all Track B blocked.”** Claim B3.

**Track B note (2026-09-14):** Planner unblocked Track B for remote workers. B0–B2 DONE on laptop. CLOUD-B3 is OPEN. Fixture CI stays mock-safe; live FB Business Discovery UAT needs human `FACEBOOK_*` after PR merge. Do not remove Instagram Login Insights.
