...
| 10 | CLOUD-B3 | Competitor Business Discovery + reel ideas (FB Login token) | IN_PROGRESS | `cloud/b3-` | [phases/B3-competitor-discovery.md](./phases/B3-competitor-discovery.md) |
...
- **First OPEN for workers right now:** none while CLOUD-B3 is IN_PROGRESS (`cloud/b3-competitor-discovery`). Do not start another row.
...
**Track B note (2026-09-14):** Planner unblocked Track B for remote workers. B0–B2 DONE on laptop. CLOUD-B3 is IN_PROGRESS on `cloud/b3-competitor-discovery` (agent:jarvis-lite). Fixture CI stays mock-safe; live FB Business Discovery UAT needs human `FACEBOOK_*` after PR merge. Do not remove Instagram Login Insights.
