...
| 11 | CLOUD-B4 | Live Facebook competitor UAT glue | OPEN | `cloud/b4-` | [phases/B4-competitor-uat.md](./phases/B4-competitor-uat.md) |
...
- **Track B (live Graph + competitor):** B0–B3 **DONE**. Next OPEN = **CLOUD-B4**.
- **First OPEN for workers right now:** **CLOUD-B4** → [phases/B4-competitor-uat.md](./phases/B4-competitor-uat.md)
- **TRACK-B-DEFER** stays BLOCKED — Next 16 / publish / auth / vector.

**Track B note (2026-09-14):** Laptop planner reviewed B3 (PR #14) — ACCEPT. Opened CLOUD-B4 for live FB UAT script/docs. Human must supply `FACEBOOK_*` for live curl (see LIVE_COMPETITOR_SETUP.md). TRACK-B-DEFER still BLOCKED.
